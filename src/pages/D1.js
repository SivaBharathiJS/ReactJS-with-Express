...
function Page1() {
  ...
  State.map((item,index)=>{return (
   ...
   <tr key={index} className="">
          ...
          <td>{item.Location}</td>
          <td>{item.Contact}</td>
          <th><Button variant="outline-danger" href={"http://localhost:3000/page2/"+item.Id}>edit</Button></th>
          <th><Button variant="outline-primary" onClick={hand(item.Id)}>delete</Button></th>
          <th><Button variant="outline-dark" href={"http://localhost:3000/page4/"+item.Id}>view</Button></th>
